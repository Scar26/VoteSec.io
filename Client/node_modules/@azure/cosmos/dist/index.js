(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('universal-user-agent'), require('tslib'), require('@azure/cosmos-sign'), require('binary-search-bounds'), require('priorityqueuejs'), require('semaphore'), require('crypto-hash'), require('fast-json-stable-stringify'), require('uuid/v4'), require('node-abort-controller'), require('node-fetch'), require('atob')) :
    typeof define === 'function' && define.amd ? define(['exports', 'universal-user-agent', 'tslib', '@azure/cosmos-sign', 'binary-search-bounds', 'priorityqueuejs', 'semaphore', 'crypto-hash', 'fast-json-stable-stringify', 'uuid/v4', 'node-abort-controller', 'node-fetch', 'atob'], factory) :
    (factory((global.Microsoft = global.Microsoft || {}, global.Microsoft.Azure = global.Microsoft.Azure || {}, global.Microsoft.Azure.Cosmos = {}),global.userAgent,global.tslib_1,global.cosmosSign,global.bs,global.PriorityQueue,global.semaphore,global.cryptoHash,global.stableStringify,global.uuid,global.AbortController,global.fetch,global.atob));
}(this, (function (exports,userAgent,tslib_1,cosmosSign,bs,PriorityQueue,semaphore,cryptoHash,stableStringify,uuid,AbortController,fetch,atob) { 'use strict';
